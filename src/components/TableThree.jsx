        ...
        <table className='w-full table-auto'>
          ...
          <tbody>
            <tr>
              ...
              <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                <p className='text-black dark:text-white'>54</p>
              </td>
              <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
            ...
            <tr>
              ...
              <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                <p className='text-black dark:text-white'>Jan 14,2023</p>
              </td>
              <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
            ...
            <tr>
              ...
              <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                <p className='text-black dark:text-white'>Fev 02,2023</p>
              </td>
              <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                <p className='text-black dark:text-white'>222</p>
              </td>
              <td className='border-b border-[#eee] py-5 px-4 dark:border-strokedark'>
                <div className='flex items-center space-x-3.5'>
                  <button className='hover:text-primary'>

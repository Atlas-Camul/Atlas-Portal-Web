...
const Header = (
    ...
    const [jsonData, setJsonData] = useState({ nameUser: '', emailUser: '' });
        ...
        <header className='sticky top-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none'>
            <div className='flex flex-grow items-center justify-between py-4 px-4 shadow-2 md:px-6 2xl:px-11'>
                <div className='flex items-center gap-2 sm:gap-4 lg:hidden'>
                    ...
                    <Link className='block flex-shrink-0 lg:hidden dark:hidden' to='/'>
                        <img src={LogoIcon} alt='Logo' />
                    </Link>

                    <Link className='block flex-shrink-0 lg:hidden hidden dark:block' to='/'>
                ...
                <div className='flex items-center gap-3 2xsm:gap-7'>
                    ...
                    {/* <!-- User Area --> */}
                    <DropdownUser jsonData={jsonData} />
                    {/* <!-- User Area --> */}
                </div>
            </div>
        </header>

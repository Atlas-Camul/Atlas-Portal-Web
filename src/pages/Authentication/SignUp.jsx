...
const SignUp = () => {
    ...
    function inputElements() {
        ...
        //pegar o retypassword 
        const repassword = document.getElementById('repasswordClient').value;

       /**
        * comparação de retype password com o password
        * se for diferente retorna null
        * faz a verificação de cada um dos campos
        * se estiverem vazios retorna nulo
        * faz a verificação se o campo email segue uma estrutura de email
        * faz o bloqueio da senha para  ser restrita a apenas 8 caracteres
                    ...
                    <div className='flex flex-wrap items-center'>
                        ...
                        <div className='w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2'>
                            <div className='w-full p-4 sm:p-12.5 xl:p-17.5'>
                                ...
                                <span className='mb-9 block font-medium'>Never get lost when in ISEP</span>

...
const Settings = () => {
    const [formData, setFormData] = useState({ fullName: '', email: '', phone: '', password: '', repassword: '' })
    ...
    const verifyLabels = () => {
        ...
        if (formData.password !== '') {
            if ((formData.password.length || formData.repassword.length) != 8) {

...
exports.CreateRestrictionService = void 0;
...
class CreateRestrictionService {
    execute({ name, type, latitude, longitude, zoneID }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const restriction = yield restrictionRepository.create({ name, type, latitude, longitude, zoneID });
            return restriction;
        });
    }
}
exports.CreateRestrictionService = CreateRestrictionService;

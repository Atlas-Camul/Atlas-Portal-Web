...
exports.DeleteRestrictionService = void 0;
...
class DeleteRestrictionService {
    execute(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const restriction = yield restrictionRepository.delete(restrictionExist);
            return restriction;
        });
    }
}
exports.DeleteRestrictionService = DeleteRestrictionService;
